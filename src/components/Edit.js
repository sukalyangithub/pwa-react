...
class Edit extends Component {
  ...
  componentDidMount() {
    axios.get('http://localhost:9091/contacts/'+this.props.match.params.id)
      .then(res => {
  ...
  onSubmit = (e) => {
    ...
    axios.put('http://localhost:9091/contacts/'+this.props.match.params.id, { name, address, city, postalCode, phone })
      .then((result) => {
